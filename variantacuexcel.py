...
def main():
    ...
    with st.sidebar:
        ...
        csv_files = st.file_uploader("Upload your CSV files here", accept_multiple_files=True)  # Adaugă secțiune pentru CSV
        ...
        if st.button("Upload"):
            with st.spinner("Processing"):
                ...
                for csv_file in csv_files:
                    df = pd.read_csv(csv_file)  # Citește fișierul CSV folosind pandas
                    # Poți face aici ce dorești cu dataframe-ul df
